...
\chemeq{C_{2}H_{4} + 3O_{2} \rightarrow 2CO_{2} + 2H_{2}O \tag{2}}
...
water <- ethylene*2
oxygen_at_end <- (excess-((oxygen)+(ethylene*3))) # unreacted oxygen
...
## data frame to plot the stoitiometric table
## the previous vectors are used as rows and columns
table <- data.frame(weight, i_moles, i_mass, o_moles)
colnames(table) <- c("weight", "input moles", 
    "input mass", "output moles") # column names
